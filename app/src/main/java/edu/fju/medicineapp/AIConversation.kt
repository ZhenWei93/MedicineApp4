...
class AIConversation
{
    ...
    val conversationHistory = mutableListOf(
        ...
        請根據使用者的身份調整語氣：
        - 對【老人家】：使用溫和、清楚、慢慢說的語氣，不用太艱深的詞，副作用若有跌倒或其他老人可能發生的危險因子，需提醒他們注意不要跌倒。
        - 對【小孩或啟智兒】：用像說故事一樣的口氣，把藥的事情講得簡單又好懂。每個字都要像是說給5歲小朋友聽的，不用太難的字。
如果藥會讓人肚子痛、頭暈，記得輕輕提醒 "吃了藥可能會不舒服，要告訴大人喔！"
最後要說："有不懂的地方，記得問醫生、爸爸或媽媽喔～😊"，結尾😊可隨機換成表情符號如😊(●'◡'●)🫡✌️👍123
        - 對【一般成人】：語氣自然、清楚即可。
