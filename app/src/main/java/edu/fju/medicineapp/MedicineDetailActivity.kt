...
class MedicineDetailActivity: AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        if (medicineCode != null)
        {
            ...
            ApiUtility.fetchMedicineDetails(this, medicineCode)
            { medicine ->
                ...
                runOnUiThread()
                {
                    if (medicine != null)
                    {
                        ...
                        // 顯示圖片
                        Glide.with(this).load(medicine.imageAPath).into(imageAPathImageView)
                        Glide.with(this).load(medicine.imageBPath).into(imageBPathImageView)
    ...
    fun registerReceiver()
    {
        ...
        DownloadUtility.getInstance().registerReceiver(this, object: DownloadInterface
        {
            ...
            override fun onError(errorCode: Int)
            {
                ...
                Toast.makeText(this@MedicineDetailActivity, "查無仿單", Toast.LENGTH_SHORT).show()
